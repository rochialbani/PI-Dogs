...
const CreateDog = () => {
    ...
    function validate(value){
        ...
        else if(Number(value.weight_min) <= 1 || Number(value.weight_min) > 99){
        ...
        else if(Number(value.weight_max) <= 1 || Number(value.weight_max) > 99){
        ...
        else if(Number(value.weight_min) > 9 && Number(value.weight_max) < 10){
            err.weight_max= 'The maximum weight of the dog cannot be less than the minimum weight'
        }
        ...
        else if(Number(value.height_min) < 10 || Number(value.height_min) > 99){
        ...
        else if(Number(value.height_max) < 10 || Number(value.height_max) > 999){
        ...
        <div className={s.img}>
            ...
            <form onSubmit={(e) => handleSubmit(e)}>
                ...
                <div>
                    ...
                    {error.life_span_min && (<p className={s.error}>{error.life_span_min}</p>)}
                </div>
                <div>
                    <label> Life span Max: </label>
                    <input type="text"  name='life_span_max' value={input.life_span_max} onChange={(e)=>handleChange(e)}/>
                    {error.life_span_max && (<p className={s.error}>{error.life_span_max}</p>)}
                </div>
                <div>
